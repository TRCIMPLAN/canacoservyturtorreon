...
FINAL;
    ...
    protected function seccion_grafica_html() {
        return <<<FINAL
      <h3>Gráfica de Tasa de Robo de VehÍculos en Torreón</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 11.7453 },{ fecha: '2009-12-31', dato: 11.7453 },{ fecha: '2010-12-31', dato: 11.7453 },{ fecha: '2011-12-31', dato: 21.8533 },{ fecha: '2012-12-31', dato: 23.1372 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
