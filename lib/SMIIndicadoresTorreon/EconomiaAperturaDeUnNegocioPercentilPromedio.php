...
FINAL;
    ...
    protected function seccion_grafica_html() {
        return <<<FINAL
      <h3>Gráfica de Apertura de un Negocio (percentil promedio) en Torreón</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 0.3445 },{ fecha: '2009-12-31', dato: 0.2255 },{ fecha: '2010-12-31', dato: 0.2255 },{ fecha: '2011-12-31', dato: 0.3788 },{ fecha: '2012-12-31', dato: 0.3788 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
