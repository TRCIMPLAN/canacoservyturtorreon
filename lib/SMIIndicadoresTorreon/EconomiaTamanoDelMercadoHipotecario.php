...
FINAL;
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 12.8723 },{ fecha: '2009-12-31', dato: 12.6830 },{ fecha: '2010-12-31', dato: 12.4964 },{ fecha: '2011-12-31', dato: 13.7856 },{ fecha: '2012-12-31', dato: 14.0575 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
