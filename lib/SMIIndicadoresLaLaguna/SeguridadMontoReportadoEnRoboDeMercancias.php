...
FINAL;
    ...
    protected function seccion_grafica_html() {
        return <<<FINAL
      <h3>Gráfica de Monto Reportado en Robo de Mercancías en La Laguna</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 0.40 },{ fecha: '2009-12-31', dato: 0.27 },{ fecha: '2010-12-31', dato: 0.30 },{ fecha: '2011-12-31', dato: 0.20 },{ fecha: '2012-12-31', dato: 0.09 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
FINAL;
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 0.07 },{ region: 'Gómez Palacio', dato: 0.16 },{ region: 'Lerdo', dato: 0.03 },{ region: 'Matamoros', dato: 0.01 },{ region: 'La Laguna', dato: 0.09 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
