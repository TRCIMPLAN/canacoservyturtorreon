...
class EconomiaTamanoDelMercadoHipotecario extends \SMIBase\PublicacionWeb {
    ...
    protected function seccion_datos_html() {
      ...
      <p><b>Unidad:</b> Créditos por cada mil habitantes.</p>
FINAL;
    } // seccion_datos_html
    ...
    protected function seccion_grafica_html() {
        return <<<FINAL
      <h3>Gráfica de Tamaño del Mercado Hipotecario en La Laguna</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 8.2033 },{ fecha: '2009-12-31', dato: 8.0950 },{ fecha: '2010-12-31', dato: 7.9881 },{ fecha: '2011-12-31', dato: 9.2852 },{ fecha: '2012-12-31', dato: 9.7623 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
FINAL;
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 14.0575 },{ region: 'Gómez Palacio', dato: 5.5430 },{ region: 'Lerdo', dato: 4.8046 },{ region: 'Matamoros', dato: 3.5920 },{ region: 'La Laguna', dato: 9.7623 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
