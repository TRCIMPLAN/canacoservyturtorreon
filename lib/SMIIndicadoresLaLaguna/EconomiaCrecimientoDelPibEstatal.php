...
FINAL;
    ...
    protected function seccion_grafica_html() {
        return <<<FINAL
      <h3>Gráfica de Crecimiento del PIB Estatal en La Laguna</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 2.7500 },{ fecha: '2009-12-31', dato: 2.7500 },{ fecha: '2010-12-31', dato: 2.7500 },{ fecha: '2011-12-31', dato: 2.7500 },{ fecha: '2012-12-31', dato: 2.7500 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
FINAL;
    ...
    protected function seccion_otras_regiones_html() {
        return <<<FINAL
      <h3>Gráfica con los últimos datos de Crecimiento del PIB Estatal</h3>
      <div id="graficaOtrasRegiones" class="grafica"></div>
      <h3>Últimos datos de Crecimiento del PIB Estatal</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Región</th>
...
FINAL;
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 3.1200 },{ region: 'Gómez Palacio', dato: 1.7300 },{ region: 'Lerdo', dato: 1.7300 },{ region: 'Matamoros', dato: 3.1200 },{ region: 'La Laguna', dato: 2.7500 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
