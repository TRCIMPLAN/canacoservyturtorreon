...
class EconomiaAperturaDeUnNegocioPercentilPromedio extends \SMIBase\PublicacionWeb {
    ...
    protected function seccion_datos_html() {
      ...
      <p><b>Unidad:</b> Percentil promedio.</p>
FINAL;
    } // seccion_datos_html
    ...
    protected function seccion_grafica_html() {
        return <<<FINAL
      <h3>Gráfica de Apertura de un Negocio (percentil promedio) en La Laguna</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 0.3876 },{ fecha: '2009-12-31', dato: 0.3666 },{ fecha: '2010-12-31', dato: 0.3666 },{ fecha: '2011-12-31', dato: 0.5279 },{ fecha: '2012-12-31', dato: 0.5279 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
FINAL;
    ...
    protected function seccion_otras_regiones_html() {
        return <<<FINAL
      <h3>Gráfica con los últimos datos de Apertura de un Negocio (percentil promedio)</h3>
      <div id="graficaOtrasRegiones" class="grafica"></div>
      <h3>Últimos datos de Apertura de un Negocio (percentil promedio)</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Región</th>
...
FINAL;
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 0.3788 },{ region: 'Gómez Palacio', dato: 0.6770 },{ region: 'Lerdo', dato: 0.6770 },{ region: 'Matamoros', dato: 0.3788 },{ region: 'La Laguna', dato: 0.5279 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
