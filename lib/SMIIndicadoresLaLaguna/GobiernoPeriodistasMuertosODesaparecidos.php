 ...
 */
class GobiernoPeriodistasMuertosODesaparecidos extends \SMIBase\PublicacionWeb {
...
FINAL;
    ...
    protected function seccion_grafica_html() {
        return <<<FINAL
      <h3>Gráfica de Periodistas Muertos o Desaparecidos en La Laguna</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 0 },{ fecha: '2009-12-31', dato: 2 },{ fecha: '2010-12-31', dato: 3 },{ fecha: '2011-12-31', dato: 6 },{ fecha: '2012-12-31', dato: 6 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
FINAL;
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 5 },{ region: 'Gómez Palacio', dato: 1 },{ region: 'Lerdo', dato: 0 },{ region: 'Matamoros', dato: 0 },{ region: 'La Laguna', dato: 6 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
