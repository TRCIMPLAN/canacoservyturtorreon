...
class SeguridadTasaDeRoboDeVehiculos extends \SMIBase\PublicacionWeb {
    ...
    protected function seccion_datos_html() {
      ...
      <h3>Observaciones</h3>
<p>Fuente: Secretariado Ejecutivo del Sistema Nacional de Seguridad Pública (SESNSP) e INEGI, 2008-2012.</p>
...
FINAL;
    ...
    protected function seccion_grafica_html() {
        return <<<FINAL
      <h3>Gráfica de Tasa de Robo de VehÍculos en La Laguna</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 23.5055 },{ fecha: '2009-12-31', dato: 23.5055 },{ fecha: '2010-12-31', dato: 23.5055 },{ fecha: '2011-12-31', dato: 23.5055 },{ fecha: '2012-12-31', dato: 19.0018 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
FINAL;
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 23.1372 },{ region: 'Gómez Palacio', dato: 7.5040 },{ region: 'Lerdo', dato: 40.1776 },{ region: 'Matamoros', dato: 8.3992 },{ region: 'La Laguna', dato: 19.0018 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
